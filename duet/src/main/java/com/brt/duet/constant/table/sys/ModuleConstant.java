...
public interface ModuleConstant {
     ...
     * @description 模块名称
     */
    TableColumn NAME = new TableColumn("name", "sys_module.name", 12, "^[\\s\\S]{0,255}$");
    /**
     * @description 模块标题
     */
    TableColumn TITLE = new TableColumn("title", "sys_module.title", 12, "^[\\s\\S]{0,255}$");
    /**
     * @description 模块编码
     */
    TableColumn CODE = new TableColumn("code", "sys_module.code", 12, "^[A-Za-z0-9_]{1,255}$");
    /**
